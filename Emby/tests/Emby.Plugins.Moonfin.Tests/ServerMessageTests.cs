...
/// <summary>
/// ServerMessage is hand-copied between the two plugins and is identical today. These assertions
/// are the same ones the Jellyfin suite makes, so a change to one side that is not mirrored to the
/// other fails here.
/// </summary>
public class ServerMessageTests
{
    ...
    public void IsVisibleTo_TargetedMessageReachesOnlyItsTargets()
    {
        ...
        // Being an admin doesn't grant access to someone else's message.
